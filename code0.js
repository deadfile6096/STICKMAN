...
gdjs.IntroCode.GDTWITTERObjects1= [];
gdjs.IntroCode.GDTWITTERObjects2= [];
gdjs.IntroCode.GDTWITTERObjects3= [];
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11794476);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11795572);
}
}
if (isConditionTrue_0) {
...
};gdjs.IntroCode.mapOfGDgdjs_9546IntroCode_9546GDTWITTERObjects1Objects = Hashtable.newFrom({"TWITTER": gdjs.IntroCode.GDTWITTERObjects1});
...
gdjs.copyArray(runtimeScene.getObjects("TWITTER"), gdjs.IntroCode.GDTWITTERObjects1);
...
gdjs.IntroCode.GDTWITTERObjects1.length = 0;
gdjs.IntroCode.GDTWITTERObjects2.length = 0;
gdjs.IntroCode.GDTWITTERObjects3.length = 0;
